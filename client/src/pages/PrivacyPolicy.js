      ...
      <main style={{ 
        ...
        >
          ...
          <p style={{
            ...
            At PackGo, we take your privacy seriously. This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you use our travel planning platform.
          </p>
          <div style={{
            background: 'var(--sand)',
            padding: '1rem 1.5rem',
            ...
            <p style={{ color: 'var(--ocean)', fontSize: '0.9rem', margin: 0 }}>
              <strong>📌 Quick Overview:</strong> We only collect necessary data to provide you with
              the best travel planning experience. We never sell your personal information.
            </p>
          </div>
        </motion.div>
          ...
          >
            ...
            <ul style={{
              ...
              {section.content.map((item, i) => (
                <li key={i} style={{
                  padding: '0.75rem 0',
                  borderBottom: i < section.content.length - 1 ? '1px solid rgba(26, 74, 107, 0.08)' : 'none',
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.75rem'
                }}>
