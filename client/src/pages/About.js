...
const About = () => {
  return (
    <div className="wander-page">
      ...
      <section className="wander-hero" style={{ minHeight: "60vh" }}>
        <div className="wander-hero-content">
          ...
          <p>
            ...
            destinations with carefully curated itineraries and seamless planning.
          </p>
        </div>
      ...
      {/* ═══ MISSION SECTION ═══ */}
      <section className="wander-features-section" style={{ background: "var(--cream)", padding: "5rem 1.5rem" }}>
        <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto 3rem" }}>
          ...
          <p style={{ color: "var(--ocean-light)", marginTop: "1rem" }}>
            To empower travellers with authentic, safe, and unforgettable experiences – without the stress of planning.
          </p>
        </div>
        <div className="wander-feat-grid">
          <div className="wander-feat-card">
            ...
            <div className="wander-feat-desc">We work with local experts to uncover hidden gems and cultural treasures.</div>
          </div>
          <div className="wander-feat-card">
            <div className="wander-feat-icon">💚</div>
            <div className="wander-feat-title">Sustainable Tourism</div>
            <div className="wander-feat-desc">Every trip supports local communities and minimises environmental impact.</div>
          </div>
          <div className="wander-feat-card">
            <div className="wander-feat-icon">✈️</div>
            <div className="wander-feat-title">Stress‑Free Planning</div>
            <div className="wander-feat-desc">From flights to activities – we handle every detail so you can focus on the joy.</div>
          </div>
        </div>
      </section>
      ...
      <section className="wander-testi-section" style={{ background: "white" }}>
        <div className="wander-stats-grid" style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="wander-stat-box"><div className="wander-stat-big">40K+</div><div className="wander-stat-desc">Happy travellers</div></div>
          <div className="wander-stat-box"><div className="wander-stat-big">120+</div><div className="wander-stat-desc">Countries</div></div>
          <div className="wander-stat-box"><div className="wander-stat-big">24/7</div><div className="wander-stat-desc">Support</div></div>
          <div className="wander-stat-box"><div className="wander-stat-big">4.9★</div><div className="wander-stat-desc">Average rating</div></div>
        </div>
      </section>
