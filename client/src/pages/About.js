      ...
      <div className="wander-page">
        ...
        <section className="wander-hero" style={{ minHeight: "60vh" }}>
          <div className="wander-hero-content">
            ...
            <p>
              PackGo was born from a passion for exploration and a desire to
              make extraordinary journeys accessible to everyone. Since 2018,
              we’ve helped over 40,000 travellers discover the world’s most
              breathtaking destinations with carefully curated itineraries and
              seamless planning.
            </p>
          </div>
        ...
        >
          ...
          <div className="wander-feat-grid">
            ...
            <div className="wander-feat-card">
              ...
              <div className="wander-feat-desc">
                Every trip supports local communities and minimises
        ...
        {/* ═══ STATS SECTION ═══ */}
        <section
          className="wander-testi-section"
