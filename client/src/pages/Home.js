    ...
    <div className="packgo-page">
      ...
      <header className="packgo-hero">
        <h1 className="packgo-hero-title">
          Pack your <span className="font-serif highlight">dreams</span>, we'll handle the <span className="font-serif highlight">plan</span>
        </h1>
        ...
        <div className="packgo-hero-visual-wrapper">
          ...
          <div className="packgo-search-bar">
            ...
            <input type="text" placeholder="Check in" className="search-input" />
            <input type="text" placeholder="Total travellers" className="search-input" />
      ...
      <section id="features" className="packgo-features-section">
        ...
        <div className="packgo-features-grid">
          <div className="feature-card">
            ...
            <p>Create, organize, and manage every journey in one place. Plan trips with destination autocomplete, track their progress from Planned to Completed, set personalized budgets, and enjoy automatically fetched destination images that bring every itinerary to life.</p>
          </div>
          <div className="feature-card">
            <div className="feature-divider"></div>
            <h3>Budget and expense tracking</h3>
            <p>Stay on top of your travel spending with an intuitive expense tracker. Categorize expenses, monitor budget utilization through interactive progress indicators, visualize spending patterns with insightful charts, and export your records whenever you need them.</p>
          </div>
          <div className="feature-card">
            <div className="feature-divider"></div>
            <h3>Remove Language Barriers</h3>
            <p>Break language barriers wherever you go. Instantly translate text into more than 28 languages, detect languages automatically, access commonly used travel phrases, and copy translations with a single click for seamless communication.</p>
          </div>
          <div className="feature-card">
            <div className="feature-divider"></div>
            <h3>Weather insights</h3>
            <p>Travel confidently with accurate weather forecasts for your destination. View current conditions, explore a detailed 5-day forecast, and receive smart travel recommendations based on the expected temperature and weather.</p>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="packgo-connect-section">
        ...
        <p>Questions, feedback, or collaboration? We'd love to hear from you. Stay connected through our social channels and be part of our travel community.</p>
      ...
      <footer className="packgo-footer">
        ...
        <div className="footer-right">
          <div className="footer-nav-col">
            <h4>Features</h4>
            <ul>
              <li><a href="#1">Trip planning</a></li>
              <li><a href="#2">Expense tracking</a></li>
              <li><a href="#3">Weather insights</a></li>
            </ul>
          </div>
          <div className="footer-nav-col">
            <h4>Learn more</h4>
            <ul>
              ...
              <li><a href="#2">Case studies</a></li>
              <li><a href="#3">Customer stories</a></li>
              <li><a href="#4">Best practices</a></li>
            </ul>
          </div>
          <div className="footer-nav-col">
            <h4>Support</h4>
