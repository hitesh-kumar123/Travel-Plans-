    ...
    <div className="wander-page" data-theme={theme}>
      ...
      <nav className={`wander-nav ${scrolled ? "wander-nav-scrolled" : ""}`}>
        ...
        <div className="wander-nav-actions">
          ...
          {isAuthenticated ? (
            <Link to="/dashboard">
              <button className="wander-btn-primary">My Dashboard</button>
            </Link>
          ) : (
            <Link to="/register">
              <button className="wander-btn-primary">Book Now</button>
            </Link>
          )}
        </div>
      ...
      <section className="wander-hero">
        ...
        <p>
          Curated journeys to the world's most extraordinary places. Handpicked
          experiences, flawless planning, memories that last forever.
        </p>
          ...
          <div>
            ...
            <div className="wander-section-title">
              {loading
                ...
                : where.trim()
                  ? `${filteredDestinations.length} escapes found`
        ...
        <div className="wander-dest-grid">
          {editorialDests[0] ? (
            ...
            <motion.div
              variants={fadeInUp}
              className="wander-dest-card tall"
              onClick={() => handleAddTrip({ name: "Santorini" })}
            >
              <SceneSantorini />
              <div className="wander-dest-overlay" />
              <div className="wander-dest-info">
          ...
          {[
            {
              svg: <SceneIceland />,
              name: "Reykjavik",
              loc: "Iceland • From ₹1,15,000",
            },
            {
              svg: <SceneAngkor />,
              name: "Angkor Wat",
              loc: "Cambodia • From ₹65,000",
            },
            {
              svg: <SceneBali />,
              name: "Ubud, Bali",
              loc: "Indonesia • From ₹55,000",
            },
            {
              svg: <SceneSahara />,
              name: "Sahara Desert",
              loc: "Morocco • From ₹95,000",
            },
          ].map((item, idx) => {
            ...
            {[
              {
                ...
                desc: "Handcrafted routes designed by local travel experts for the perfect experience.",
              },
              {
                icon: <Shield size={28} />,
                title: "Safe & Insured",
                desc: "Full trip protection and 24/7 emergency support included in all packages.",
              },
              {
                icon: <Zap size={28} />,
                title: "Instant Booking",
                desc: "Confirm your dream holiday in minutes without endless back-and-forth emails.",
              },
            ].map((f, i) => (
              <motion.div
                key={i}
        ...
        <div className="wander-testi-grid">
          <motion.div variants={fadeInUp}>
            ...
            <div className="wander-quote">
              ...
              grandkids about. Every single detail was perfect.
            </div>
